    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-orange-50 py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        {(!profileCompleted) ? (
          ...
          <div className="space-y-8">
            {/* Wallet and Referral Earnings Section */}
            <section className="py-12 bg-white">
              <div className="container mx-auto px-4">
                <h2 className="text-3xl font-bold text-center mb-8 text-gray-800">Your Earnings</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                  ...
                  <Card className="border-2 border-blue-500">
                    ...
                    <CardContent>
                      <p className="text-3xl font-bold text-gray-800">₹{walletData.wallet_balance.toFixed(2)}</p>
                  ...
                  <Card className="border-2 border-green-500">
                    ...
                    <CardContent>
                      <p className="text-3xl font-bold text-gray-800">₹{walletData.total_earned.toFixed(2)}</p>
                  ...
                  <Card className="border-2 border-purple-500">
                    ...
                    <CardContent>
                      <p className="text-3xl font-bold text-gray-800">{referralEarnings.length}</p>
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Your latest referral commissions</CardDescription>
                  </CardHeader>
                  <CardContent>
                    {referralEarnings.length > 0 ? (
                          ...
                          <div key={earning.id} className="flex justify-between items-center p-4 border rounded-lg">
                            <div>
                              ...
                              <p className="text-sm text-gray-600">
                                From {earning.package_name || 'Unknown Package'} purchase
                              </p>
                            </div>
                            <div className="text-right">
                              <p className="text-sm text-gray-600">
                                {earning.purchaseDate.toLocaleDateString()}
                              </p>
                              <p className="text-xs text-gray-500">
                                {earning.commission_type === 'owned' ? 'Owned Commission' : 'Unowned Commission'}
                              </p>
                            </div>
                          </div>
                        ))}
                      ...
                      <p className="text-gray-600 text-center py-4">No referral earnings yet</p>
                    )}
                  </CardContent>
                </Card>
              </div>
